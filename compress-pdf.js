...
function getBinPath(platform) {
  ...
  throw new Error("not possible to get binaries path, unsupported platform was provided");
}
...
function arrayLikeKeys(value, inherited) {
  ...
  for (var key in value) {
    if ((inherited || hasOwnProperty$4.call(value, key)) && !(skipIndexes && (key == "length" || isBuff && (key == "offset" || key == "parent") || isType && (key == "buffer" || key == "byteLength" || key == "byteOffset") || _isIndex(key, length)))) {
      result.push(key);
    }
  }
  return result;
...
var defaults = _baseRest(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === void 0 || eq_1(value, objectProto$7[key]) && !hasOwnProperty$6.call(object, key)) {
...
export {compress_default as compress, get_bin_path_default as getBinPath};
export default null;